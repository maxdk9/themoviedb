...
class MainNavigation {
  ...
  String initialRoute(bool isAuth) {
    return isAuth? MainNavigationRouteNames.mainScreen:MainNavigationRouteNames.auth;
    }
  ...
  final routes = <String, Widget Function(BuildContext context)>{
    ...
    MainNavigationRouteNames.mainScreen: (context) =>NotifierProvider(create:()=> MainScreenModel(), child: MainScreenWidget()),
  ...
  Route<Object> onGenerateroute(RouteSettings settings){
    ...
    switch(settings.name){
      ...
      case MainNavigationRouteNames.movieDetails:
        ...
        return MaterialPageRoute(builder: (context)=> NotifierProvider(create:()=>MovieDetailsModel(moveId: movieId),child: const MovieDetailWidget()),);

      case MainNavigationRouteNames.movieTrailer:
        final arguments=settings.arguments;
        final youtubeKey=arguments is String ? arguments: '';
        return MaterialPageRoute(builder: (context)=>MovieTrailerWidget(youtubeKey: youtubeKey));
      default:
