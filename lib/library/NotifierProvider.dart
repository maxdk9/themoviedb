...
//   const NotifierProvider({Key? key, required this.create, required this.child,  this.isManagingModel=true }) : super(key: key);
...
//         .getElementForInheritedWidgetOfExactType<InheritedNotifierProvider<Model>>()
//         ?.widget;
...
// class InheritedNotifierProvider<Model extends ChangeNotifier> extends InheritedNotifier {
//   final Model model;
